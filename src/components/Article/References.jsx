...
export default class References extends Component {
  render() {
    return (
      <div className="border reference">
        <ul className="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li className="nav-item">
            <a className="nav-link" id="profile-tab" data-toggle="tab" href="#resource" role="tab" aria-controls="resource" aria-selected="false">Resource</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" id="contact-tab" data-toggle="tab" href="#reference" role="tab" aria-controls="reference" aria-selected="false">Reference</a>
          </li>
        </ul>
